...
public class BookingServiceImpl implements BookingService {
    ...
    public BookingServiceImpl(BookingRepository bookingRepository, BookingPassengerRepository bookingPassengerRepository, UserRepo userRepo, TrainRepository trainRepository, TrainScheduleRepository trainScheduleRepository, ModelMapper modelMapper, StationRepo stationRepo, TrainSeatRepository trainSeatRepository) {
...
//        coaches.sort((s1, s2) -> s1.getTrainSeatOrder() - s2.getTrainSeatOrder());
        coaches.sort(Comparator.comparing(
                TrainSeat::getTrainSeatOrder,
        ...
        bookingResponse.setTotalFair(savedBooking.getTotalFare());
